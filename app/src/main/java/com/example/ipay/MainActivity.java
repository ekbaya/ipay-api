...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String amount           = "1";
        String phone_number     = "0712695820";
        String email            = "Eliasbaya1223@gmail.com";
        String vid              = "wwkl"; //Vendor ID
        ...
        String airtel_status   = "0";
        String easy_status     = "0";
        String visa_status     = "0";
